import style from "../modal/Modals.module.css";
...
const Modals=()=>{
    return(
        <section className={style.secmodal}>
            ...
            <div className={style.closebtn}>
                <button className={style.btnclose}><AiOutlineClose /></button>
            </div>
